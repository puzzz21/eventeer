...
@foreach($events as $event)
    <div class="container-fluid create">
        <div class="row">
            <form class="form-horizontal" role="form" method="POST" id="sub" action="{{ route('event_update') }}" enctype="multipart/form-data">
                {!! csrf_field() !!}
                ...
                <div class="col-md-3" id="left">
                    ...
                    <div class="col-md-8 form-group" id="fnt" style="margin-left:50px;">
                        ...
                        <?php
                            $et=explode(",",$event->event_type);
                            ?>

                        <fieldset class="form-group" id="catChoices">
                            <label><input type="checkbox" name="event_type" value="music"  {{ !array_has($et, 'music') ?: 'checked' }} id="c"> music</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="technology" id="c" {{ !array_has($et, 'technology') ?: 'checked' }} > technology</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="sports & wellness" id="c" {{ !array_has($et, 'sports & wellness') ?: 'checked' }} > sports & wellness</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="food & drinks" id="c" {{ !array_has($et, 'food & drinks') ?: 'checked' }}>food & drinks</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="arts" id="c" {{ !array_has($et, 'arts') ?: 'checked' }}>arts</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="classes" id="c" {{ !array_has($et, 'classes') ?: 'checked' }}>classes</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="parties" id="c" {{ !array_has($et, 'parties') ?: 'checked' }}>parties</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="networking" id="c" {{ !array_has($et, 'networking') ?: 'checked' }}>networking</label>
                            <br/>
                            <label><input type="checkbox" name="event_type" value="causes" id="c" {{ !array_has($et, 'causes') ?: 'checked' }}>causes</label>
                        </fieldset>
                        <div class="file-field">
                            <div class="btn col-md-12" style="background:#4B515D;">
                                <span>Choose image for your event</span>
                                <input type="file" name="logo" value=" {{ $event->logo }}" accept='image/*'>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-9">
                    <div class="card" id="right">
                        <div class="card-block">
                            ...
                            <div class="md-form">
                                <input type="text" id="title" name="event_name" class="form-control" value="{{ $event->event_name }}" required="true">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-form">
                                        ...
                                        <input type="text" class="form-control datetimepicker3" name="event_start_datetime"  required="true">
                                ...
                                <div class="col-md-6">
                                    <div class="md-form">
                                        ...
                                        <input type="text" required="true" class="form-control datetimepicker3" name="event_end_datetime"  required="true">
                            ...
                            <div class="row">
                                ...
                                <div class="md-form" style="margin-left:15px;float:left;">
                                    ...
                                    <input id="venue" type="text" class="form-control" name="venue" value="{{ $event->venue }}" required="true">
                            ...
                            <div class="md-form">
                                <textarea id="abc" style="overflow-y: scroll;resize: none; height:150px" name="description" class="md-textarea" rows="10" required="true">{{ $event->description }}</textarea>
                            ...
                            <div class="md-form">
                                ...
                                <textarea name="special_requirements" style="overflow-y: scroll;resize: none; height:120px" rows="7" class="md-textarea" >{{ $event->special_requirements }}</textarea>
                            </div>
